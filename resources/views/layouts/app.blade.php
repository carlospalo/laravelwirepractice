...
<body class="flex flex-wrap justify-center bg-gray-200">
    
  
    <div class="flex w-full">
        <div class="bg-gray-200 w-1/6 shadow-2xl ">
            <div class="flex flex-col sm:flex-row sm:justify-around ">    
                <div class="w-full h-screen bg-gray-800 mt-8 sm:mt-0">
                    ...
                    <nav class="mt-10 text-gray-400">
                        <a class="flex items-center py-4 px-8 block    {{ Request::is('/') ? 'bg-gray-700 border-r-4 border-gray-100 text-gray-100' : '' }}" href="/">
                        ...
                        {{-- <a class="flex items-center  py-4 px-8 block text-gray-400 border-r-4 border-gray-800 hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100" href="#">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
         ...
         --}}
                        <a class="flex items-center  py-4 px-8 block   hover:bg-gray-700 hover:text-gray-100 hover:border-gray-100 {{ Request::is('tickets') ? 'bg-gray-700 border-r-4 border-gray-100 text-gray-100' : '' }}" href="/tickets">
                            <svg class="h-5 w-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    {{-- <div class="absolute bottom-0 my-10">
                        <a class="flex items-center py-4 px-8 block text-gray-600 hover:text-gray-500" href="#">
        ...
        <div class="w-5/6">
            <div class="flex w-full justify-end px-4 bg-purple-900 text-white">
                @auth
                <livewire:logout />
                @endauth
                @guest
